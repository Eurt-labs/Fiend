...
3. All string edits should be made to the `fiend/app/src/main/res/values/fiend_strings.xml` file, NOT `fiend/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `metrolist_strings.xml` files in the project. ONLY edit the default (English) `metrolist_strings.xml` file, DO NOT EDIT OTHER LANGUAGES.
