...
# Since Fiend is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.fiend.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep PO-token utility classes
-keep class com.fiend.music.utils.potoken.** { *; }
...
-keep class com.fiend.music.models.PersistQueue { *; }
-keep class com.fiend.music.models.PersistPlayerState { *; }
-keep class com.fiend.music.models.QueueData { *; }
-keep class com.fiend.music.models.QueueType { *; }
-keep class com.fiend.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.fiend.music.cast.** { *; }
...
-keep class com.fiend.music.recognition.VibraSignature { *; }
-keepclassmembers class com.fiend.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.fiend.music.listentogether.proto.** { *; }
-keepclassmembers class com.fiend.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.fiend.shazamkit.models.** { *; }
-keepclassmembers class com.fiend.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.fiend.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.fiend.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.fiend.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
