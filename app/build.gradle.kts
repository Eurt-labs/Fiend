...
val baseApplicationId = "com.fiend.music"
val applicationIdOverride = System.getenv("FIEND_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("FIEND_APP_NAME")?.takeIf { it.isNotBlank() }
val buildCommit =
    System.getenv("FIEND_BUILD_COMMIT")
        ?.trim()
        ?.takeIf { it.matches(Regex("[0-9a-fA-F]{7,40}")) }
        ?.take(7)
        ?.lowercase()
val debugKeystorePathOverride = System.getenv("FIEND_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("FIEND_DEBUG_KEYSTORE_PASSWORD") ?: "android"
val debugKeyAlias = System.getenv("FIEND_DEBUG_KEY_ALIAS") ?: "androiddebugkey"
val debugKeyPassword = System.getenv("FIEND_DEBUG_KEY_PASSWORD") ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        resValue("string", "app_name", appNameOverride ?: "Fiend")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Fiend Debug")
            }
            signingConfig =
...
val cleanLegacyProtoSources = tasks.register<Delete>("cleanLegacyProtoSources") {
    delete(layout.projectDirectory.dir("src/main/java/com/fiend/music/listentogether/proto"))
}
