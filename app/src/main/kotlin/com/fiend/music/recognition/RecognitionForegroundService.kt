package com.fiend.music.recognition
...
import com.fiend.music.widget.MusicRecognizerWidgetReceiver
...
class RecognitionForegroundService : Service() {
    ...
    private fun handleSuccess(result: RecognitionResult) {
        ...
        updateNotification(
            ...
            actionTitle = getString(R.string.listen_on_fiend),
        )
    ...
    companion object {
        ...
        const val ACTION_START_WIDGET_RECOGNITION = "com.fiend.music.widget.recognizer.START"
        const val ACTION_STOP_WIDGET_RECOGNITION = "com.fiend.music.widget.recognizer.STOP"
