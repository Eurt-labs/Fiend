...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.fiend.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.fiend.music.widget.LIKE"
        const val ACTION_NEXT = "com.fiend.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.fiend.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.fiend.music.widget.UPDATE_WIDGET"
    }
}
