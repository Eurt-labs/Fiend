package com.fiend.music.discord
...
import com.fiend.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.fiend.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.fiend.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "fienddiscord://oauth2/callback"
