...
import com.fiend.innertube.models.Thumbnail
import com.fiend.innertube.models.Thumbnails
import com.fiend.innertube.models.response.PlayerResponse
import com.fiend.innertubex.InnerTubeLogLevel
import com.fiend.innertubex.InnerTubeLogger
import com.fiend.innertubex.cipher.PlayerConfigRepository
import com.fiend.innertubex.cipher.RemotePlayerConfigStore
import com.fiend.innertubex.cipher.YouTubeCipherService
import com.fiend.innertubex.extraction.AudioQuality as InnerTubeXAudioQuality
import com.fiend.innertubex.extraction.ContentHints
import com.fiend.innertubex.extraction.ExtractedStream
import com.fiend.innertubex.extraction.InnerTubeExtractor
import com.fiend.innertubex.extraction.PoTokenResult
import com.fiend.innertubex.extraction.StreamResolveException
import com.fiend.innertubex.extraction.TokenProvider
import com.fiend.innertubex.extraction.TokenProviderCapabilities
import com.fiend.innertubex.extraction.YtConfigParserImpl
import com.fiend.innertubex.extraction.generateClientPlaybackNonce
import com.fiend.innertubex.extraction.strategy.PoTokenProviderKind
import com.fiend.music.constants.AudioQuality
import com.fiend.music.utils.potoken.PoTokenGenerator
    ...
    private suspend fun bundle(): ExtractionBundle {
        ...
        return bundleMutex.withLock {
            ...
            try {
                ...
                logger.log(
                    com.fiend.innertubex.InnerTubeLogEvent(
