...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/Eurt-labs/Fiend"
    private const val KMP_RELEASES_URL = "https://api.github.com/repos/Eurt-labs/Fiend/releases?per_page=30"
    const val KMP_APK_NAME = "Fiend.apk"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Fiend.apk" -> "universal" to "foss"
                name == "Fiend-with-Google-Cast.apk" -> "universal" to "gms"
