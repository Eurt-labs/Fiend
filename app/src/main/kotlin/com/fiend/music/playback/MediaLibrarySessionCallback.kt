...
import com.fiend.innertube.models.filterExplicit
import com.fiend.innertube.models.filterVideoSongs
import com.fiend.music.R
import com.fiend.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.fiend.music.constants.AndroidAutoSectionsOrderKey
import com.fiend.music.constants.AndroidAutoYouTubePlaylistsKey
...
import com.fiend.music.ui.screens.settings.AndroidAutoSection
import com.fiend.music.ui.screens.settings.deserializeSections
import com.fiend.music.ui.screens.settings.serializeSections
                ...
                val children = when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.fiend.innertube.pages.HomePage.Section>()
