...
package com.fiend.music.models
...
data class MediaMetadata(
    ...
    fun toYTItem() = SongItem(
        id = id,
        title = title,
        artists = artists.map { com.fiend.innertube.models.Artist(name = it.name, id = it.id) },
        album = album?.let { com.fiend.innertube.models.Album(name = it.title, id = it.id) },
        duration = duration,
