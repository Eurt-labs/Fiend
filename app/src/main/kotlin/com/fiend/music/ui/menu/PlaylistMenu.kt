...
import com.fiend.music.ui.menu.ExportDialog
import com.fiend.music.utils.PlaylistExporter
import com.fiend.music.utils.getExportFileUri
import com.fiend.music.utils.saveToPublicDocuments
    ...
    LazyColumn(
        ...
        item {
            Material3MenuGroup(
                items =
                    buildList {
                        if (editable && autoPlaylist != true && true) {
                            add(
                                Material3MenuItemData(
    ...
    if (showExportDialog) {
        ExportDialog(
            ...
            onShare = { format ->
                val playlistSongs =
                    songs.map { s ->
                        com.fiend.music.db.entities.PlaylistSong(
                            map =
                                com.fiend.music.db.entities.PlaylistSongMap(
                                    songId = s.id,
