...
import com.fiend.music.constants.ContentCountryKey
import com.fiend.music.constants.ContentLanguageKey
import com.fiend.music.constants.CountryCodeToName
import com.fiend.music.constants.EnableBetterLyricsKey
import com.fiend.music.constants.EnableKugouKey
import com.fiend.music.constants.EnableLrcLibKey
import com.fiend.music.constants.EnablePaxsenixKey
import com.fiend.music.constants.EnableLyricsPlus
...
import com.fiend.music.constants.LanguageCodeToName
import com.fiend.music.constants.LyricsProviderOrderKey
import com.fiend.music.constants.ProxyEnabledKey
import com.fiend.music.constants.ProxyPasswordKey
import com.fiend.music.constants.ProxyTypeKey
import com.fiend.music.constants.ProxyUrlKey
import com.fiend.music.constants.ProxyUsernameKey
import com.fiend.music.constants.QuickPicks
import com.fiend.music.constants.QuickPicksKey
import com.fiend.music.constants.RandomizeHomeOrderKey
import com.fiend.music.constants.SYSTEM_DEFAULT
import com.fiend.music.constants.ShowArtistDescriptionKey
import com.fiend.music.constants.ShowMostStatsPlaylistsKey
import com.fiend.music.constants.ShowArtistSubscriberCountKey
import com.fiend.music.constants.ShowMonthlyListenersKey
...
import com.fiend.music.ui.component.DraggableLyricsProviderItem
import com.fiend.music.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.fiend.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.fiend.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.fiend.music.db.entities.PlaylistEntity(
                        id = com.fiend.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.fiend.music.db.entities.PlaylistEntity(
                        id = com.fiend.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
