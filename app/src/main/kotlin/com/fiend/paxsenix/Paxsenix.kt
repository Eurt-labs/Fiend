package com.fiend.paxsenix

import android.content.Context
import com.fiend.music.betterlyrics.TTMLParser
import com.fiend.paxsenix.models.AppleMusicSearchResponse
import com.fiend.paxsenix.models.LyricsResponse

import com.fiend.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Fiend/$appVersion")
                }
