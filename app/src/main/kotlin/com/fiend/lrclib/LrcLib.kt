package com.fiend.lrclib

import com.fiend.lrclib.models.Track
import com.fiend.lrclib.models.bestMatchingFor
import com.fiend.lrclib.models.bestMatchingForRelaxed
...
object LrcLib {
    ...
    suspend fun getLyrics(
        ...
        val matchedTrack = tracks.bestMatchingFor(duration, cleanedTitle, cleanedArtist)
            ?: tracks.bestMatchingForRelaxed(duration)
        val res = matchedTrack?.let { track ->
