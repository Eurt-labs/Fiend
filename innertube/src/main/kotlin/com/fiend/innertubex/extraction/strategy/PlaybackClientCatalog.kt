package com.fiend.innertubex.extraction.strategy
...
object PlaybackClientCatalog : PlaybackClientCatalogView {
    ...
    private const val SOURCE_FIEND = SOURCE_PLAYBACK_MATRIX
    ...
    val manifests: List<PlaybackClientManifest> =
        listOf(
            ...
            manifest(
                ...
                evidence = setOf(SOURCE_ANDROID_BENCHMARK, SOURCE_FIEND),
                notes =
            ...
            manifest(
                ...
                evidence = setOf(SOURCE_ANDROID_BENCHMARK, SOURCE_FIEND, SOURCE_YTDLP, SOURCE_YOUTUBE_JS),
                notes =
            ...
            manifest(
                ...
                benchmarkContent = globallyUnusableContent(),
                evidence = setOf(SOURCE_ANDROID_BENCHMARK, SOURCE_FIEND, SOURCE_YTDLP),
                notes =
            ...
            manifest(
                ...
                evidence = setOf(SOURCE_FIEND, SOURCE_YTDLP),
                notes =
            ...
            manifest(
                ...
                content = normalSongsOnlyContent(),
                benchmarkContent = globallyUnusableContent(),
                evidence = setOf(SOURCE_ANDROID_BENCHMARK, SOURCE_ANDROID_SABR_BENCHMARK, SOURCE_FIEND, SOURCE_YTDLP),
                notes =
            ...
            manifest(
                ...
                evidence = setOf(SOURCE_ANDROID_BENCHMARK, SOURCE_ANDROID_SABR_BENCHMARK, SOURCE_FIEND),
                notes =
            ...
            manifest(
                ...
                content = nativeDirectUnusableContent(),
                evidence = setOf(SOURCE_FIEND, SOURCE_YTDLP, SOURCE_YOUTUBE_JS),
                notes =
            ...
            manifest(
                ...
                content = globallyUnusableContent(),
                evidence = setOf(SOURCE_FIEND, SOURCE_YOUTUBE_JS),
